...
void I2C_Configuration(void)
{
  ...
  I2C_InitStructure.I2C_OwnAddress1 = MPU6050_SLA_ADR; // MPU6050 7-bit adress = 0x68, 8-bit adress = 0xD0; 
...
//data_len: lenght of reading data
{
  ...
  I2C_GenerateSTART(MPU6050_I2C, ENABLE);
	...
	I2C_Send7bitAddress(MPU6050_I2C, MPU6050_WADR, I2C_Direction_Transmitter);
	while(!I2C_CheckEvent(MPU6050_I2C, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED));
	//I2C_Cmd(MPU6050_I2C, ENABLE);// clear all the event	
  ...
  I2C_GenerateSTART(MPU6050_I2C, ENABLE);
	...
	I2C_Send7bitAddress(MPU6050_I2C, MPU6050_RADR, I2C_Direction_Receiver);
  ...
  while(data_len)
    ...
    {
      i2c_rdata[i] = I2C_ReceiveData(MPU6050_I2C);
			i++;
      data_len--;
		}
	}
